...
const Finance = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap  justify-between items-center mx-8 mt-2 px-4 gap-4">
        <p className="text-blue-800 font-bold flex-auto sm:flex-grow-0 w-full md:w-auto order-3 sm:order-1 mt-4 sm:mt-0">AUTOS EN PROMOCION</p>
        <button
